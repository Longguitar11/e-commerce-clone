...
const Hero = () => {
    ...
    return (
        <section className='py-8'>
            <div className="container mx-auto xl:max-w-335 min-[750px]:px-[50px]">
                <div className='flex gap-16'>
                    <div className='space-y-4 flex-1'>
                        <div className='relative'>
                            ...
                            <img src="https://cdn.shopify.com/s/files/1/0917/5649/5191/files/nysale.png?v=1766822224" alt="" className='absolute top-4 right-4 max-w-30' />
                    ...
                    <div className='flex-1 font-nunito space-y-4'>
                        <div className='flex items-center gap-4'>
                            <img src="https://cdn.shopify.com/s/files/1/0917/5649/5191/files/Frame_229.png?v=1752064359" alt="" className='w-[100px]' />
                            <p>4.8/5 Excellent | Based on 2381 Reviews</p>
                        </div>

                        <p className='font-lora text-[28px] leading-[1.4em]'>New Maximum Potency Formula - Lymphatic Drainage Capsules by Sculptique™</p>
                        ...
                        <div className={classNames('flex gap-3 transition-all duration-300 ease-in-out', isHideReviews
                            ...
                            <div className='flex gap-[10px] items-center pt-2 pl-2 pb-2.5'>
                                <div className='flex justify-center items-center gap-1'>
                                    ...
                                    <p className='font-lora font-medium text-center text-[#212121]'>Clinicians'
                                        <br />
                                        Choice</p>
                                ...
                                <div className='font-opensans space-y-[6px] text-[13px]'>
                                    ...
                                    <p className=''><span className='font-semibold'>336 clinicians</span> share this on <span className='italic'>FrontrowMD</span> <br /> without compensation. <span className='underline underline-offset-4 cursor-pointer'>Learn more</span></p>
                                    ...
                                    <div className='flex gap-[6px] items-center'>
                                        ...
                                        <button className='hover:underline hover:underline-offset-4 text-[#212121] font-semibold'>
